...
## Click to expand: ROCS Framework Reference Table
...
The most common prompt problems fall into four patterns. Read the first one carefully; expand the rest as needed.
...
::: {.callout-tip collapse="true"}
## Click to expand: Failure 2 — The Implicit Assumption
...
::: {.callout-tip collapse="true"}
## Click to expand: Failure 3 — The Kitchen Sink
...
::: {.callout-tip collapse="true"}
## Click to expand: Failure 4 — The Leading Question
...
::: {.callout-tip collapse="true"}
## Click to expand: Example — Iterating on a literature summary
